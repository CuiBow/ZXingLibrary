...
package com.example.scancore.camera;
...
public final class CameraManager {
    ...
    private static final int MAX_FRAME_WIDTH = ScreenUtils.getScreenWidth()+100; // = 5/8 * 1920
    private static final int MAX_FRAME_HEIGHT = ScreenUtils.getScreenHeiSubStatusHei(); // = 5/8 * 1080
